...
-- -------------------------------------------------------
-- Requete 1 : SELECT + JOIN
-- Tous les passagers avec leur adresse (ville et pays)
-- -------------------------------------------------------
SELECT
    p.id,
    p.nom,
...
-- -------------------------------------------------------
-- Requete 2 : SELECT + JOIN multiple
-- Tous les billets avec passager, vol et compagnie
-- -------------------------------------------------------
SELECT
    b.numero_billet,
...
-- -------------------------------------------------------
-- Requete 3 : SELECT + WHERE
-- Reservations confirmees uniquement
-- -------------------------------------------------------
SELECT
...
-- -------------------------------------------------------
-- Requete 4 : SELECT + GROUP BY
-- Total paye par passager
-- -------------------------------------------------------
SELECT
    CONCAT(p.prenom, ' ', p.nom) AS passager,
...
-- -------------------------------------------------------
-- Requete 5 : SELECT + JOIN avec aeroports
-- Vols avec aeroport de depart, arrivee et porte
-- -------------------------------------------------------
SELECT
    v.numero_vol,
    v.date_vol,
