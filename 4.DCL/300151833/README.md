...
![Connexion psql en tant que postgres](1.png)
...
![Liste des relations dans tp_dcl](2.png)
...
![GRANT sur la séquence pour le professeur](3.png)
...
![SELECT réussi en tant qu'étudiant, INSERT refusé](4.png)
...
![REVOKE et vérification de l'accès refusé](6.png)
